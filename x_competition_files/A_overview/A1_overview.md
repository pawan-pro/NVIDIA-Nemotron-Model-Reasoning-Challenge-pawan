...
Particiapnts will experminent with prompting, data pipelines, and lightweight fine-tuning while evaluating their approaches on a new reasoning benchmark developed by NVIDIA Research. 

### Start
a month ago 

### End
2 months to go (Merger & Entry)
...
You must submit a LoRA adapter of rank at most 32 for the NVIDIA Nemotron-3-Nano-30B model packaged into a submission.zip file. You may consider adapting the NVIDIA Nemotron Submission Demo (https://www.kaggle.com/code/ryanholbrook/nvidia-nemotron-submission-demo)(herperlink 3) to produce your submission.
...
Participants must submit their entry for these awards through this form (https://docs.google.com/forms/d/1O9XN6v0fCDkBVChbbcorBmT95rhca6_ELz8RwwJnx9c/viewform?edit_requested=true)linking to their notebook and clearly identifying the category being entered.
